...
#ifndef CHROME_BROWSER_CMUX_TERM_CMUX_RAIL_ANIMATING_LAYOUT_MANAGER_H_
#define CHROME_BROWSER_CMUX_TERM_CMUX_RAIL_ANIMATING_LAYOUT_MANAGER_H_
...
// the class name and collection-neutral comments were adapted for cmux
// workspaces. See THIRD_PARTY_NOTICES.md.
//
// A simple LayoutManager for nested rail collections that animates changes
...
class CmuxRailAnimatingLayoutManager
 ...
 public:
  ...
  explicit CmuxRailAnimatingLayoutManager(
  ...
  CmuxRailAnimatingLayoutManager(
      const CmuxRailAnimatingLayoutManager&) = delete;
  CmuxRailAnimatingLayoutManager& operator=(
      const CmuxRailAnimatingLayoutManager&) = delete;
  ~CmuxRailAnimatingLayoutManager() override;
...
#endif  // CHROME_BROWSER_CMUX_TERM_CMUX_RAIL_ANIMATING_LAYOUT_MANAGER_H_
